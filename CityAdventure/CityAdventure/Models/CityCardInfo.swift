...
struct CityCardLocalDB {
    ...
    init(s_name: String, s_type: String, ui_cityNo: Int32, ui_cardNo: Int32, s_kanji: String, t_kanjiExplain: String, t_slogan: String, t_cityExplain: String, t_tourURL: String, version: Int32) {
        self.s_name = s_name
        self.s_type = s_type
        self.ui_cityNo = ui_cityNo
        self.ui_cardNo = ui_cardNo
