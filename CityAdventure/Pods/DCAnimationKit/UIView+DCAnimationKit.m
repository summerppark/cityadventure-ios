...
{
    [UIView animateWithDuration:time delay:0.0 options:UIViewAnimationOptionAllowUserInteraction animations:^{
...
-(void)tada:(DCAnimationFinished)finished
{
    float dist = 3;
    float dur = 0.25;
    [UIView animateWithDuration:dur delay:0.0 options:UIViewAnimationOptionAllowUserInteraction animations:^{
